...
var Tags = function (key) {
    ...
    this.priv = {}
    this.priv.key = key;
    var baseAdd = "https://api.authorship.me";
...
//in case a custom tag was generated, the tag object is not null anymore, in which case some special treatment is necessary not to lose data
    ...
    Tags.prototype.excludeTag = function (tag, callbackError) {
      ...
      if (tagToExclude !== null) {
        apiCall("PUT", this.priv.address + "updateExcluded", buildTagJSON(tagToExclude, this.text, this.priv.key), null, callbackError);
    ...
    Tags.prototype.updateTag = function (tag, type, callbackError) {
      ...
      if (type !== null) {
        ...
        if (tagToChange !== null) {
          ...
          apiCall("PUT", this.priv.address + "updateType", buildTagJSON(tagToChange, this.text, this.priv.key), null, callbackError);
        }
      }
    };
